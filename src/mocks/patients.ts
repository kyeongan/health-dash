...
export const patients: Patient[] = [
    ...
    documents: [
      {
        ...
        url: '/mock-docs/lab-results-1.pdf',
        fileSize: 234567,
    ...
    documents: [
      {
        ...
        url: '/mock-docs/prescription-3.pdf',
        fileSize: 123456,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
    ...
    documents: [
      {
        id: 'doc7',
        name: 'Mental Health Eval.pdf',
        type: 'medical_record',
        uploadDate: '2023-11-05',
        url: '/mock-docs/mental-7.pdf',
        fileSize: 65432,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
    ...
    documents: [
      {
        id: 'doc8',
        name: 'Celiac Panel.pdf',
        type: 'test_result',
        uploadDate: '2021-02-10',
        url: '/mock-docs/celiac-8.pdf',
        fileSize: 54321,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
    ...
    documents: [
      {
        id: 'doc9',
        name: 'Cholesterol Results.pdf',
        type: 'test_result',
        uploadDate: '2020-06-20',
        url: '/mock-docs/cholesterol-9.pdf',
        fileSize: 43210,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
    ...
    documents: [
      {
        id: 'doc10',
        name: 'Dermatology Report.pdf',
        type: 'medical_record',
        uploadDate: '2022-10-20',
        url: '/mock-docs/derm-10.pdf',
        fileSize: 32109,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
    ...
    documents: [
      {
        id: 'doc11',
        name: 'Sleep Study.pdf',
        type: 'test_result',
        uploadDate: '2021-04-15',
        url: '/mock-docs/sleep-11.pdf',
        fileSize: 21098,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
    ...
    documents: [
      {
        id: 'doc12',
        name: 'Pulmonary Function.pdf',
        type: 'test_result',
        uploadDate: '2020-08-25',
        url: '/mock-docs/pulmonary-12.pdf',
        fileSize: 10987,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
    ...
    documents: [
      {
        id: 'doc13',
        name: 'Seizure Log.pdf',
        type: 'other',
        uploadDate: '2022-01-20',
        url: '/mock-docs/seizure-13.pdf',
        fileSize: 98765,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
      ...
      currentMedications: [
        {
          ...
          name: 'Lactase',
          dosage: '1 tablet',
          frequency: 'With dairy',
          prescribedBy: 'Dr. Walker',
    ...
    documents: [
      {
        id: 'doc14',
        name: 'Lactose Tolerance.pdf',
        type: 'test_result',
        uploadDate: '2023-03-10',
        url: '/mock-docs/lactose-14.pdf',
        fileSize: 87654,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
    ...
    insurance: {
      provider: 'Texas Health',
      policyNumber: 'TH789012',
    ...
    documents: [
      {
        id: 'doc15',
        name: 'Muscle Spasm Note.pdf',
        type: 'other',
        uploadDate: '2021-11-10',
        url: '/mock-docs/muscle-15.pdf',
        fileSize: 76543,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
    ...
    documents: [
      {
        id: 'doc16',
        name: 'Diabetes Log.pdf',
        type: 'other',
        uploadDate: '2022-05-15',
        url: '/mock-docs/diabetes-16.pdf',
        fileSize: 65432,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
    ...
    insurance: {
      provider: 'Nevada Health',
      policyNumber: 'NH234567',
      effectiveDate: '2020-08-01',
      copay: 30,
      deductible: 2000,
    },
  ...
  },
  {
    ...
    gender: 'male',
    lastName: 'Baker',
    dateOfBirth: '1969-06-06',
    email: 'henry.baker@example.com',
    phone: '555-9014',
    address: {
      street: '951 Willow Dr',
      city: 'Columbus',
      state: 'OH',
      zipCode: '43004',
      country: 'USA',
    ...
    documents: [
      {
        id: 'doc19',
        name: 'Oncology Report.pdf',
        type: 'medical_record',
        uploadDate: '2020-06-25',
        url: '/mock-docs/oncology-19.pdf',
        fileSize: 32109,
        mimeType: 'application/pdf',
      },
    ],
  ...
  },
  {
    ...
    documents: [
      {
        id: 'doc20',
        name: 'Allergy Action Plan.pdf',
        type: 'other',
        uploadDate: '2022-09-10',
        url: '/mock-docs/allergy-20.pdf',
        fileSize: 21098,
        mimeType: 'application/pdf',
      },
    ],
